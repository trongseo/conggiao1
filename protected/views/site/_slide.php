...
<div id="slider1_container" style="display: none; position: relative; margin: 0 auto;
    top: 0px; left: 0px; width: 1008px; height: 268px; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1130px; height: 300px; overflow: hidden;">
            ...
            ?>
            <div>
                <img u="image" src="<?php echo Yii::app()->baseUrl.'/upload/slide/'.$s->images?>" />
            </div>
            <?php endforeach;?>
        </div>
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (bodyWidth)
                    jssor_slider1.$ScaleWidth(Math.min(bodyWidth, 1008));
                else
